...
export const INITIAL_DATA = {
  ...
  problema: {
    ...
    cards: [
      ...
      { icon: 'dollar', title: 'Tecnología solo para élite', desc: 'Las herramientas profesionales de análisis cuestan miles de dólares. Inaccesibles para clubes amateurs.' },
    ],
    quote: {
  ...
  solucion: {
    ...
    metricas: [
      { icon: 'target', name: 'Line-Out', desc: 'YOLO detecta cada formación de line-out con su minuto exacto y nivel de confianza.' },
      { icon: 'layers', name: 'Scrum',    desc: 'Identifica scrums y los marca en el timeline para revisión rápida.' },
      { icon: 'rocket', name: 'Salida',   desc: 'Detecta kick-offs al inicio del partido y después de cada try.' },
    ],
    features: [
  ...
  tecnologia: {
    ...
    items: [
      { icon: 'brain',      name: 'YOLO v8',         role: 'Detección con IA' },
      { icon: 'video',      name: 'OpenCV + ffmpeg', role: 'Procesamiento y compresión' },
      { icon: 'code',       name: 'Python',          role: 'Motor del análisis' },
